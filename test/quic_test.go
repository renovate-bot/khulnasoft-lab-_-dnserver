...
import (
	...
	ctls "github.com/khulnasoft-lab/dnserver/plugin/pkg/tls"
...
func TestQUIC(t *testing.T) {
	q, udp, _, err := DNServerServerAndPorts(quicCorefile)
	if err != nil {
...
// convertAddress transforms the address given in DNServerServerAndPorts to a format
