...
import (
	...
	"github.com/khulnasoft-lab/dnserver/plugin/metrics"
...
func TestMetricsServer(t *testing.T) {
	...
	srv, err := DNServerServer(corefile)
	if err != nil {
...
func TestMetricsRefused(t *testing.T) {
	...
	srv, udp, _, err := DNServerServerAndPorts(corefile)
	if err != nil {
		t.Fatalf("Could not get DNServer serving instance: %s", err)
	}
	defer srv.Stop()
