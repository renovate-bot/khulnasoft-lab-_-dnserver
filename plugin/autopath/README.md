...
on Pods. When Pod IP assignments change, the Kubernetes API notifies DNServer via the API watch.
...
the API watch can notify DNServer of the change, *autopath* will resolve the IP to the previous Pod's
namespace.
