...
interface](https://godoc.org/github.com/khulnasoft-lab/dnserver/plugin/metadata#Provider) will be called for
...
The [Provider interface](https://godoc.org/github.com/khulnasoft-lab/dnserver/plugin/metadata#Provider) and
the [package level](https://godoc.org/github.com/khulnasoft-lab/dnserver/plugin/metadata) documentation.
