...
The plugin reloads the content of the hosts file every 5 seconds. Upon reload, DNServer will use the
...
PTR records for reverse lookups are generated automatically by DNServer (based on the hosts file
