...
* **VERSION** is the version to return. Defaults to `DNServer-<version>`, if not set.
...
version.bind version.server authors.bind hostname.bind id.server {
    chaos DNServer-001 info@dnsserver.khulnasoft.com
}
~~~
...
...
;; ANSWER SECTION:
version.bind.		0	CH	TXT	"DNServer-001"
...
~~~
