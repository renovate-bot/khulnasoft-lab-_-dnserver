...
If DNServer can't find a Corefile on startup this is the _default_ plugin that gets loaded. As such
it can be used to check that DNServer is responding to queries. Other than that this plugin is of
...
When queried for "example.org A", DNServer will respond with:
...
[blog]: https://dnsserver.khulnasoft.com/2017/03/01/how-to-add-plugins-to-coredns/
[code]: https://github.com/khulnasoft-lab/dnserver/blob/master/plugin/whoami/
