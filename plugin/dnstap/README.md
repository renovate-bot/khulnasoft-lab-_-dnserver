...
plugin you make DNServer output dnstap logging.
...
* **VERSION** to override the version field. Defaults to the DNServer version.
...
~~~ go
import (
  "github.com/khulnasoft-lab/dnserver/plugin/dnstap/msg"
