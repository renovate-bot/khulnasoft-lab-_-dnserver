...
This causes two lookups from DNServer to etcd in certain cases.
...
Reverse zones are supported. You need to make DNServer aware of the fact that you are also
