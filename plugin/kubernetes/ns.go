...
// nsAddrs returns the A or AAAA records for the DNServer service in the cluster. If the service cannot be found,
...
func (k *Kubernetes) nsAddrs(external, headless bool, zone string) []dns.RR {
	...
	// If no DNServer endpoints were found, use the localIPs directly
	if !foundEndpoint {
