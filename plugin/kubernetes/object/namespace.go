...
// Namespace is a stripped down api.Namespace with only the items we need for DNServer.
type Namespace struct {
	// Don't add new fields to this struct without talking to the DNServer maintainers.
	Version string
	Name    string
