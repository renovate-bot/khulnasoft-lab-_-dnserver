...
func (APIConnServiceTest) SvcIndex(string) []*object.Service {
	svcs := []*object.Service{
		...
		},
		{
			Name:         "external",
			Namespace:    "testns",
			ExternalName: "dnsserver.khulnasoft.com",
...
func TestServices(t *testing.T) {
	...
	tests := []svcTest{
		...
		// External Services
		{qname: "external.testns.svc.interwebs.test.", qtype: dns.TypeCNAME, answer: []svcAns{{host: "dnsserver.khulnasoft.com", key: "/" + coredns + "/test/interwebs/svc/testns/external"}}},
