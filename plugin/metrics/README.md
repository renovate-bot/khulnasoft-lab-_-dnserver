...
With *prometheus* you export metrics from DNServer and any plugin that has them.
...
Prometheus will not reply HTTP request until a successful reload or a complete restart of DNServer.
