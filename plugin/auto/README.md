...
* `reload` interval to perform reloads of zones if SOA version changes and zonefiles. It specifies how often DNServer should scan the directory to watch for file removal and addition. Default is one minute.
