...
**WARNING** there is a syntactical problem with Go templates and DNServer config files. Expressions
 like `{{$var}}` will be interpreted as a reference to an environment variable by DNServer (and
...
DNServer supports [caddyfile environment variables](https://caddyserver.com/docs/caddyfile#env)
