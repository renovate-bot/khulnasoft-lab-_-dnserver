...
//
// See https://github.com/khulnasoft-lab/dnserver/issues/2723 for some discussion on this, which includes this quote:
//
// TL;DR: `fallthrough` is indeed risky and hackish, but still a good feature of DNServer as it allows to quickly answer boring edge cases.
package fall
