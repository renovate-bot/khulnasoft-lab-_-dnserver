...
*not committed* to disk (a violation of the RFC). This means restarting DNServer will cause it to
retrieve all secondary zones.

If the primary server(s) don't respond when DNServer is starting up, the AXFR will be retried
