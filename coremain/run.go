...
// Run is DNServer's main() function.
func Run() {
	caddy.TrapSignals()
	flag.Parse()
...
// versionString returns the DNServer version as a string.
func versionString() string {
	return fmt.Sprintf("%s-%s\n", caddy.AppName, caddy.AppVersion)
}

// releaseString returns the release information related to DNServer version:
...
var (
	...
	// Gitcommit contains the commit where we built DNServer from.
	GitCommit string
)
