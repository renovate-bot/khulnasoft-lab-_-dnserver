...
import (
	...
	"github.com/khulnasoft-lab/dnserver/plugin/metrics/vars"
	"github.com/khulnasoft-lab/dnserver/plugin/pkg/edns"
	"github.com/khulnasoft-lab/dnserver/plugin/pkg/log"
	"github.com/khulnasoft-lab/dnserver/plugin/pkg/rcode"
	"github.com/khulnasoft-lab/dnserver/plugin/pkg/reuseport"
	"github.com/khulnasoft-lab/dnserver/plugin/pkg/trace"
	"github.com/khulnasoft-lab/dnserver/plugin/pkg/transport"
...
// NewServer returns a new DNServer server and compiles all plugins in to it. By default CH class
